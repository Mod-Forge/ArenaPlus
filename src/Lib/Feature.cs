...
{
    public class FeatureInfoAttribute(string id, string name, string description, bool enabledByDefault, string category = "General", string[] requires = null, string[] incompatibilities = null, string color = "None") : BaseFeatureInfoAttribute(id, name, description, enabledByDefault)
    {
